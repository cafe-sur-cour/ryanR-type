...
PacketManager::PacketManager(uint32_t seqNumber) {
    ...
    this->_packetLengths = {
        {static_cast<uint8_t>(CONNECTION_CLIENT_PACKET), LENGTH_CONNECTION_PACKET},
        {static_cast<uint8_t>(ACCEPTATION_PACKET), LENGTH_ACCEPTATION_PACKET},
        {static_cast<uint8_t>(DISCONNECTION_PACKET), LENGTH_DISCONNECTION_PACKET},
        {static_cast<uint8_t>(EVENT_PACKET), LENGTH_EVENT_PACKET}
    };
}
