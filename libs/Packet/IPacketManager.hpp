...
#define DEATH_PLAYER_PACKET 0x0C
#define WHOAMI_PACKET 0x0D
#define SERVER_STATUS_PACKET 0x0E
#define REQUEST_LOBBY_PACKET 0x0F
#define SEND_LOBBY_CODE_PACKET 0x10
