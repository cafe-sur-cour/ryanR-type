...
namespace rserv {
    class Server : public IServer {
        public:
            ...
            std::shared_ptr<std::queue<std::pair<uint8_t, constants::EventType>>> getEventQueue() override;
        ...
        private:
            ...
            std::shared_ptr<std::queue<std::pair<uint8_t, constants::EventType>>> _eventQueue;
