...
void DevState::drawScoreHUD(std::shared_ptr<gfx::IWindow> window, int score) {
    size_t barX = 250;
    size_t barY = static_cast<size_t>(constants::MAX_HEIGHT - 35);
    ...
    window->drawText(
        scoreText, colors::YELLOW, scorePosition, "assets/fonts/abduction2002.ttf", 20
    );
