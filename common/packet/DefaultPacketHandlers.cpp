...
bool registerDefaultPacketHandlers(
    ...
    registerSingleUCharPacket(packet, ser, GAME_RULES_PACKET, LENGTH_GAME_RULES_PACKET);
    registerOptionalULongPacket(packet, ser, REQUEST_GAME_RULES_CHANGE_PACKET);
    ...
    packet->registerLength(
        REQUEST_GAME_RULES_CHANGE_PACKET, LENGTH_REQUEST_GAME_RULES_CHANGE_PACKET);
